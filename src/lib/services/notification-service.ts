...
class NotificationService {
  ...
  private alreadyLoggedDenied = false;
    ...
    try {
      ...
      if (isTauri) {
        ...
        if (Notification.permission === 'denied') {
          ...
          if (!this.alreadyLoggedDenied) {
            this.alreadyLoggedDenied = true;
  ...
  async notify(options: NotificationOptions): Promise<void> {
    // En navigateur : si la permission est déjà refusée, ne pas rappeler requestPermission (évite le spam de logs)
