...
interface IServerApiClientPublic {
  ...
  completeCloudSso(ticket: string): Promise<ApiResponse<AuthResponse>>;
  ...
  getTorrentGroupByTmdbId(tmdbId: number, title?: string, mediaType?: 'movie' | 'tv'): Promise<ApiResponse<any>>;
