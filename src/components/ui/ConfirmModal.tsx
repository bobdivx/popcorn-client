    ...
    <Modal isOpen={isOpen} onClose={onCancel} title={title} size="sm" closeOnBackdropClick>
      ...
      <div className="flex flex-col-reverse sm:flex-row justify-end gap-3">
        <button
          ...
          data-focusable
          tabIndex={0}
          className="px-5 py-2.5 rounded-lg border border-[var(--ds-border)] bg-[var(--ds-surface-overlay)] text-[var(--ds-text-primary)] hover:bg-white/10 transition-[opacity,transform,background-color] duration-200 active:scale-95 focus:outline-none focus:ring-2 focus:ring-primary-400 min-h-[44px]"
        >
          {cancelText}
        </button>
        <button
          ...
          data-focusable
          tabIndex={0}
          className={`px-5 py-2.5 rounded-lg text-white font-medium transition-[opacity,transform,background-color] duration-200 active:scale-95 focus:outline-none focus:ring-2 min-h-[44px] ${
            danger
