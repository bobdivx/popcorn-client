...
export default function Avatar({
  ...
  if (avatarUrl) {
    return (
      <div
        className={`${sizeClassName} ${roundClass} overflow-hidden border border-white/10 bg-black/30 ${className}`}
        aria-label="Avatar"
      >
        <img
          src={avatarUrl}
  ...
  return (
    <div
      className={`${sizeClassName} ${roundClass} bg-primary text-white flex items-center justify-center font-bold shadow-primary border border-white/10 ${className}`}
      aria-label="Avatar"
    >
