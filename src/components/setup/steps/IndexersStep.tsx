      ...
      {showDefinitionSelector ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            if (name === 'apiKey') {
              return (
                <div key={name} className="space-y-2">
                  ...
                  <input type="password" className={inputClass} value={formData.apiKey} onInput={(e) => setFormData({ ...formData, apiKey: (e.target as HTMLInputElement).value })} required={effectiveDef?.requiresApiKey ?? false} placeholder={field.placeholder} autoComplete="new-password" />
                </div>
              );
            }
          ...
          <div className="space-y-2">
            ...
            <input type="password" className={inputClass} value={formData.apiKey} onInput={(e) => setFormData({ ...formData, apiKey: (e.target as HTMLInputElement).value })} placeholder={t('indexersManager.optional')} autoComplete="new-password" />
          </div>
            </>
          )}
