...
/** Enlève les séquences {} résiduelles (placeholders mal rendus par le backend) et assainit le HTML pour éviter le XSS. */
function sanitizePreviewHtml(html: string): string {
  const noPlaceholders = html.replace(/\{\}/g, '');
  return DOMPurify.sanitize(noPlaceholders, {
    ALLOWED_TAGS: [
      'b', 'i', 'u', 's', 'em', 'strong', 'a', 'p', 'br', 'hr', 'ul', 'ol', 'li', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6',
      'img', 'span', 'div', 'blockquote', 'code', 'pre', 'table', 'thead', 'tbody', 'tr', 'th', 'td'
    ],
