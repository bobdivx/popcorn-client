...
/** Enlève les séquences {} résiduelles (placeholders mal rendus par le backend) et applique DOMPurify pour éviter les XSS. */
function sanitizePreviewHtml(html: string): string {
  const noBrackets = html.replace(/\{\}/g, '');
  return DOMPurify.sanitize(noBrackets);
}
