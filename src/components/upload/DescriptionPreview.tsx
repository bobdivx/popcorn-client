...
/** Enlève les séquences {} résiduelles (placeholders mal rendus par le backend) et assainit le HTML pour éviter XSS. */
function sanitizePreviewHtml(html: string): string {
  // 1. Remove empty braces
  const noBraces = html.replace(/\{\}/g, '');
  // 2. Sanitize against XSS attacks using isomorphic-dompurify for safe SSR + CSR
