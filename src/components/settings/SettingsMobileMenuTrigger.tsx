...
export default function SettingsMobileMenuTrigger() {
  ...
  return (
    <div
      className="settings-mobile-menu-trigger md:hidden fixed left-0 z-[40] top-[calc(3.75rem+var(--safe-area-inset-top,0px))] sm:top-[calc(5rem+var(--safe-area-inset-top,0px))] pt-2 pl-[max(0.75rem,env(safe-area-inset-left,0px))]"
    >
      <button
        type="button"
