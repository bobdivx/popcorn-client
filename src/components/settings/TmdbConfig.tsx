  ...
  return (
    <div class="relative rounded-2xl shadow-2xl border border-gray-800 overflow-hidden">
      ...
      <div class="relative z-10 p-6 sm:p-8 md:p-12">
        ...
        {tmdbHasKey && (
          <div class="alert alert-success mb-4 sm:mb-6 bg-green-900/80 backdrop-blur-sm border-green-600/50">
            <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <div>
              <h3 class="font-bold">Clé API TMDB configurée</h3>
              <div class="text-sm">Votre clé API TMDB est déjà configurée et active. Vous pouvez la modifier ou la supprimer ci-dessous.</div>
            </div>
          </div>
        )}
