...
Le script vérifie automatiquement l'environnement et initialise Tauri si nécessaire. Il applique aussi les patches de compatibilité **Mobile + Android TV** (banner TV, LEANBACK_LAUNCHER, cleartext) comme le workflow CI.
